(function () {
  ...
  function buildAddButton() {
    ...
    li.appendTo('#tartanator_form_list');
    li.append(button).enhanceWithin();
  }
  ...
  function addColor (colorName, colorSize, colorValue) {
    var colorItem = [
      ...
      '<a href="#" style="background:', colorValue,
  ...
  function onFormSubmit () {
    ...
    if (!$nameInput.val() || !$colorList.find('li').length) {
     $.mobile.changePage( "dialogs/tartan-data-required.php", {
       transition: "pop",
       reverse: false,
       role: 'dialog'
      });	
